...
\*Screenshot:\* `image-20260119-095837.png`
...
\*Screenshot:\* `image-20260119-095826.png`
...
The extension checks that the current URL contains the \*\*Spark Customer Care Workspace Application ID\*\* (set this in the content.js file):
